...
def run_match(people, world_width: int=1000, world_height: int=600, predator_kill_radius=30, prey_per_team:int=45, predators_per_team:int=5, background=True, own_line_deaths=False, show_bounds=True) -> Player:
    players: List[Player] = []
    team_names: List[str] = []
    ...
    world: World = World(world_width,world_height,background, show_bounds)
